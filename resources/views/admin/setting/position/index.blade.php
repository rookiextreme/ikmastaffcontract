...
@section('content')
    ...
    @include('admin.setting.position.modals.position-modal')
@endsection
...
@section('jsCustom')
    <script>
        let moduleUrl = `admin/setting/position/`;
    </script>

    <script src="{{ asset('js/modules/admin/setting/position/init.js') }}"></script>
    <script src="{{ asset('js/modules/admin/setting/position/index.js') }}"></script>
@endsection
