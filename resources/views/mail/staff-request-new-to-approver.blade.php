                        ...
                        <table width="85%">
                            ...
                            <tr>
                                <td align="left">
                                    <h2 style="font-family:Arial;font-style:normal;font-weight:bold;line-height:30px;font-size:24px;color:#333333;">
                                        Permohonan Cuti Ini Sedang Menunggu Pengesahan</h2>
                                </td>
                            </tr>
                            ...
                            <tr>
                                <td align="left"
                                    ...
                                    Di Bawah Adalah Maklumat Permohonan Cuti: <br>
                                    Nama: {{ $user->name }}<br>
                                    E-Mel: {{ $user->email }}<br>
                                    ...
                                    <br>
                                    Sila <a href="{{ route('staff.leave.approval', ['user_id' => $entry->getApprover->getUser->id]) }}">Tekan</a> di sini untuk melihat maklumat lebih lanjut.
                                </td>
                            </tr>
                            <tr>
                                <td>&nbsp;</td>
